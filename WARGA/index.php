...
<head>
  ...
  <title>SILADES | Dashboard Warga </title>
...
<body>
  ...
  <div class="wrapper">
    <aside class="sidebar">
      ...
      <a class="menu-item text-white text-decoration-none" href="?p=ajukan_surat">
        <i class="bi bi-file-earmark-text-fill"></i> Pengajuan Surat
      </a>

      <a class="menu-item text-white text-decoration-none" href="?p=ajuan_saya">
        <i class="bi bi-clock-history"></i> Ajuan Saya
      </a>
