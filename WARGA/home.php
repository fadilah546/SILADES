     ...
     <div class="container mt-4">
       ...
       <div class="row g-3 mb-4">
         ...
         $counters = [
           ...
           ['label'=>'Diajukan','icon'=>'bi-clock-history','value'=>$totals['Diajukan']],
           ['label'=>'Diproses','icon'=>'bi-gear','value'=>$totals['Diproses']],
           ['label'=>'Selesai','icon'=>'bi-check-circle','value'=>$totals['Selesai']],
           ['label'=>'Ditolak','icon'=>'bi-x-circle','value'=>$totals['Ditolak']],
         ];
       ...
       <div class="row justify-content-between align-items-center mb-3">
         ...
         <small class="text-muted">3 ajuan terbaru anda</small>
       </div>
