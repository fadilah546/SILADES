                    ...
                    ?>
                        <form action="ubah.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                 ...
                                 <input name="nik" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Masukan NIK anda" value="<?= $d['NIK'] ?>">
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <img src="../uploads/<?= $d['KTP'] ?>" alt="KTP" class="img-fluid" style="max-width: 300px; border-radius: 8px; opacity:0.6;">
                                <input type="hidden" name="old_ktp" value="<?= $d['KTP'] ?>">
                                <input class="form-control" type="file" id="ktp" name="ktp">
                            </div>

                            <div class="mb-3">
                                <label class="form-label">KK</label><br>
                                <img src="../uploads/<?= $d['KK'] ?>" alt="KK" class="img-fluid" style="max-width: 300px; border-radius: 8px; opacity:0.6;">
                                <input type="hidden" name="old_kk" value="<?= $d['KK'] ?>">
                                <input class="form-control" type="file" id="kk" name="kk">
                            </div>

                            <div class="mb-5">
                                <label class="form-label">Surat Pengantar</label><br>
                                <img src="../uploads/<?= $d['Surat_pengantar'] ?>" alt="Surat Pengantar" class="img-fluid" style="max-width: 300px; border-radius: 8px; opacity:0.6;">
                                <input type="hidden" name="old_pengantar" value="<?= $d['Surat_pengantar'] ?>">
                    ...
                    ?>
                        <form action="ubah.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <img src="../uploads/<?= $d['Akte'] ?>" alt="Akte" class="img-fluid" style="max-width: 300px; border-radius: 8px; opacity:0.6;">
                                <input type="hidden" name="old_akte" value="<?= $d['Akte'] ?>">
                                <input class="form-control" type="file" id="akte" name="akte">
                            </div>

                            <div class="mb-5">
                                <label class="form-label">Pas Foto</label><br>
                                <img src="../uploads/<?= $d['Pas_foto'] ?>" alt="Pas Foto" class="img-fluid" style="max-width: 300px; border-radius: 8px; opacity:0.6;">
                                <input type="hidden" name="old_pas_foto" value="<?= $d['Pas_foto'] ?>">
                    ...
                    ?>
                        <form action="ubah.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-5">
                                ...
                                <img src="../uploads/<?= $d['Foto_persyaratan'] ?>" alt="Foto Persyaratan" class="img-fluid" style="max-width: 300px; border-radius: 8px; opacity:0.6;">
                                <input type="hidden" name="old_lokasi_usaha" value="<?= $d['Foto_persyaratan'] ?>">
                                <input class="form-control" type="file" id="lokasi_usaha" name="lokasi_usaha">
                            </div>
